...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|vec|[VectorInt64Handle](#type-vectorint64handle)|是|-|整型数组指针。|
...
|类型|说明|
|:----|:----|
|[VectorInt64Handle](#type-vectorint64handle)|整型数组指针。|
