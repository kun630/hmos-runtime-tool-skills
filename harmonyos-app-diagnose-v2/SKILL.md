---
name: harmonyos-app-diagnose-v2
...
# 推荐：指定 --hap 确保安装最新包
python "<skills_dir>/harmonyos-app-diagnose-v2/ui_capture.py" --emulator 5555 \
...
```powershell
python "<skills_dir>/harmonyos-app-diagnose-v2/ui_capture.py" \
