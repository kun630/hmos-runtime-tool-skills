...
2. 设置资源：需要设置属性fdSrc（表示文件描述符）。
   ...
   >
   > - 也可以使用应用沙箱路径访问对应资源（必须确认资源文件可用），请参见[获取应用文件路径](../../application-models/cj-application-context-stage.md#获取应用文件路径)。应用沙箱的介绍及如何向应用沙箱推送文件，请参见[文件管理](../../file-management/cj-app-sandbox-directory.md)。
   >
