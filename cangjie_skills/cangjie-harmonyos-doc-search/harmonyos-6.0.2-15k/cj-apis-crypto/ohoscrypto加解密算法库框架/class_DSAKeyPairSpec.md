...
**功能：** 密钥参数[AsyKeySpec](#interface-asykeyspec)的子类，用于指定DSA算法中公私钥包含的全量参数。
...
**类型：** [DSACommonParamsSpec](#class-dsacommonparamsspec)
...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|params|[DSACommonParamsSpec](#class-dsacommonparamsspec)|是|-| **命名参数。** 指定DSA算法中公私钥都包含的公共参数。|
|sk|BigInt|是|-| **命名参数。** 指定DSA算法的私钥sk。|
|pk|BigInt|是|-| **命名参数。** 指定DSA算法的公钥pk。|