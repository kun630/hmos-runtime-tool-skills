...
| 图标小符号（[SymbolGlyph](../../API_Reference/source_zh_cn/arkui-cj/cj-text-input-symbolglyph.md)/[SymbolSpan](../../API_Reference/source_zh_cn/arkui-cj/cj-text-input-symbolspan.md)） | 当需要显示小图标时，应优先考虑使用此文本组件。 |
