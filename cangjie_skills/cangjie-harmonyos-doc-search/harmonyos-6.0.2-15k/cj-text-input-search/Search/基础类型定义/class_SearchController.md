...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|carePosition|Int32|是|-|从字符串开始到光标所在位置的字符长度。|
...
|类型|说明|
|:----|:----|
|[CJCaretOffset](#struct-cjcaretoffset)|光标相对输入框的位置。|
...
|类型|说明|
|:----|:----|
|[CJRectResult](#struct-cjrectresult)|已编辑文本内容区域相对组件的位置和大小。|
...
**功能：** 设置组件在获焦状态下，调用该接口设置文本选择区域并高亮显示，且只有在selectionStart小于selectionEnd时，文字才会被选取并高亮显示。
