...
**类型：** ?[ButtonType](./cj-common-types.md#enum-buttontype)
...
**类型：** ?[ButtonRole](./cj-common-types.md#enum-buttonrole)
...
**类型：** ?[ButtonStyleMode](./cj-common-types.md#enum-buttonstylemode)
