...
| primaryButton | [AlertDialogButtonOptions](cj-dialog-alertdialog.md#class-alertdialogbuttonoptions) | 否 | AlertDialogButtonOptions() | **命名参数。**  确认Button的使能状态、默认焦点、按钮风格、文本内容、文本色、按钮背景色和点击回调。 |
| secondaryButton | [AlertDialogButtonOptions](cj-dialog-alertdialog.md#class-alertdialogbuttonoptions) | 否 | AlertDialogButtonOptions() | **命名参数。**  确认Button的使能状态、默认焦点、按钮风格、文本内容、文本色、按钮背景色和点击回调。 |