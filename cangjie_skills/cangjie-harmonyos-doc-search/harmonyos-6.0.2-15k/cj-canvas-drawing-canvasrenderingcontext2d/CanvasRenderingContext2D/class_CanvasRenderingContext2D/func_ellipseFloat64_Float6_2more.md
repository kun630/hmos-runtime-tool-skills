...
|参数名|类型|必填|默认值|说明|
|:---|:---|:---|:---|:---|
|x|Int64|是|-|椭圆圆心的x轴坐标，单位：vp。|
|y|Int64|是|-|椭圆圆心的y轴坐标，单位：vp。|
|radiusX|Int64|是|-|椭圆x轴的半径长度，单位：vp。|
|radiusY|Int64|是|-|椭圆y轴的半径长度，单位：vp。|
|rotation|Int64|是|-|椭圆的旋转角度，单位为弧度。|
|startAngle|Int64|是|-|椭圆绘制的起始点角度，以弧度表示。|
|endAngle|Int64|是|-|椭圆绘制的结束点角度，以弧度表示。|
|anticlockwise|Bool|否|false| **命名参数。** 是否以逆时针方向绘制椭圆。</br>true:逆时针方向绘制椭圆。</br>false:顺时针方向绘制椭圆。|
            ...
            Canvas(this.context).width(100.percent).height(100.percent).backgroundColor(0xffff00).onReady(
                {
                    ...
                    this.context.ellipse(200.0, 200.0, 50.0, 100.0, 3.14 * 0.25, 3.14 * 0.5, 3.14 * 2.0,
                        anticlockwise: false)
                    this.context.stroke()
                    this.context.beginPath()
                    this.context.ellipse(200.0, 300.0, 50.0, 100.0, 3.14 * 0.25, 3.14 * 0.5, 3.14 * 2.0,
                        anticlockwise: true)
                    this.context.stroke()
                }
            )
...
![ellipse](./figures/canvasrenderingcontext_20.png)